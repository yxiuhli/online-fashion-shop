    ...
    <div className="relative font-[Monaco] px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64">
      ...
      {favoriteProducts.length === 0 && (
        <div className="flex flex-col justify-center items-center">
            <div className="mt-4  text-gray-500 text-2xl">You have no favorite products yet.</div>
            <Link className="mt-4  text-blue-500 underline" href={"/list?cat=all-products"}>Add more favorite products <ArrowRightOutlined/></Link>
        </div>
